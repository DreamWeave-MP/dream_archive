//! BA2 archive support.
//!
//! BA2 has multiple payload table families. [`PayloadFormat::GNRL`] stores
//! general files, [`PayloadFormat::DX10`] stores DirectX texture metadata and
//! texture payload chunks, and [`PayloadFormat::GNMF`] identifies Sony GNM/GNF
